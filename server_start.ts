...
// Imports relative to root (proven to work in test_index_imports.ts)
...
async function startServer() {
    try {
        console.log("Starting server initialization (Root Entry Point)...");
        const app = express();
        ...
        app.use(cors({
            origin: true, // Allow all origins (or request origin)
            credentials: true,
        }));
